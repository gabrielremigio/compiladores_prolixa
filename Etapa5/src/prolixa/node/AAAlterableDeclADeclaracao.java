...
public final class AAAlterableDeclADeclaracao extends PADeclaracao
{
    private PATipo _tipo_;
    private TIdentificador _nome_;

    public AAAlterableDeclADeclaracao()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AAAlterableDeclADeclaracao(
    ...
    {
        ((Analysis) sw).caseAAAlterableDeclADeclaracao(this);
    }
