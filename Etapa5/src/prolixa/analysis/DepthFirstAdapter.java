...
public class DepthFirstAdapter extends AnalysisAdapter {
    public class Informacao {
        ...
        Tipo tipo;
        boolean isVetor;
        int tamanho; // -1 se nao for vetor
        boolean isAlterable;
        boolean isInitialized;

        Informacao(Tipo tipo, boolean isVector, int tamanho, boolean isAlterable, boolean isInitialized) {
            this.tipo = tipo;
            this.isVetor = isVector;
    ...
    Stack<HashMap<String, Informacao>> tabelaSimbolos = new Stack<HashMap<String, Informacao>>();
